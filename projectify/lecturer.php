    ...
    <div class="panel">
      <div class="overview1">
        ...
        <div class="overview2">
          <div class="over1">
            ...
            <div class="over1row2">
              <?php include "php/fetchPostTable.php"; ?>
            </div>
          </div>
          ...
          <div class="overview3">
            <div class="over2">
              ...
              <div class="over2column2">
                <p>Pending: </p>
                <p class="assignmentnumber"><?php echo $totalOfPending; ?></p>
              </div>
          ...
          <div class="over4">
            ...
            <p class="subWork"><?php echo $totalOfMark; ?></p>
      ...
      <div class="assignment1">
        ...
        <div class = "assignment2">
          <?php include "php/fetchHostTable.php"; ?>
        </div>
      </div>
